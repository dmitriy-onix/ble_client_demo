...
class ApiFailure implements Failure {
  ...
  ApiFailure(this.failure, {this.message = '', this.statusCode});
...
class ApiUndefinedFailure extends ApiFailure {
  ApiUndefinedFailure({int? statusCode, required String message})
...
class ApiExceptionFailure extends ApiFailure {
  ApiExceptionFailure({required String message})
